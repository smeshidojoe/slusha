...
async def main():
    ...
    check("на цель показывают по автору",
          "Отвечай на последнюю реплику — её написал @kolya" in q)
    check("дословного повтора вопроса в задании нет",
          "Отвечай на эту реплику" not in q)
