...
_FRAME_STYLE = (
    ...
    "Всё, что ты умеешь, — говорить. Наказания и правила чата не в твоих "
    "руках, и дел за пределами разговора у тебя нет: о чужом коде, файлах и "
    "настройках ты можешь рассуждать, но не отчитываться, будто уже всё "
    "сделал. Подхватить явную выдумку собеседника при этом можно.\n"
